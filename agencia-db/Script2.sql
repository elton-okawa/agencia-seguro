...
CREATE TABLE VendaDB (
	...
	IdCliente INT NOT NULL,
	IdFuncionario INT NOT NULL,
	PRIMARY KEY (Renavam,IdCliente,DataVenda,IdFuncionario,IdCliente,IdFuncionario)
);
...
CREATE TABLE CompraDB (
	...
	IdCliente INT NOT NULL,
	IdFuncionario INT NOT NULL,
	PRIMARY KEY (IdCliente,Renavam,DataCompra,IdFuncionario,IdCliente,IdFuncionario)
);
...
ALTER TABLE PrestadorServicoDB ADD CONSTRAINT FuncionarioContrata FOREIGN KEY (IdFuncionario)
	REFERENCES FuncionarioDB (IdFuncionario)
	ON DELETE CASCADE;
...
ALTER TABLE VendaDB ADD CONSTRAINT ClienteVende FOREIGN KEY (IdCliente)
	REFERENCES ClienteDB (IdCliente)
	ON DELETE CASCADE;
